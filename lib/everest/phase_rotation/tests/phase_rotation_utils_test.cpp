...
TEST(PhaseRotationUtilsTest, PhaseRotationIdentity) {
    ...
    apply_phase_rotation(rotated, "123");
...
TEST(PhaseRotationUtilsTest, PhaseRotation312) {
    auto pm = create_test_powermeter();

    apply_phase_rotation(pm, "312");
...
TEST(PhaseRotationUtilsTest, PhaseRotation231) {
    auto pm = create_test_powermeter();

    apply_phase_rotation(pm, "231");
